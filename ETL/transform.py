...
types_dict = {
    ...
    "snout_y": "float64",
    "likelihood": "float64",
    "leftforword_x": "float64",
    "leftforword_y": "float64",
    "likelihood.1": "float64",
    "rightforword_x": "float64",
    "rightforword_y": "float64",
    "likelihood.2": "float64",
    "midbody_x": "float64",
    "midbody_y": "float64",
    "likelihood.3": "float64",
    "leftback_x": "float64",
    "leftback_y": "float64",
    "likelihood.4": "float64",
    "rightback_x": "float64",
    "rightback_y": "float64",
    "likelihood.5": "float64",
    "tail_x": "float64",
    "tail_y": "float64",
