...
> 
> **Важно:**
> - модули делаем из вашего кода **_data_loader.py_** и **_write_to_db.py_** после чего удаляем эти скрипты!


<p align="center">
<img width="1600" height="914" alt="image" src="https://github.com/user-attachments/assets/331c9155-2951-4221-9723-5bc869e0fd05" />
</p>
...
> [!NOTE]
> В ETL преобразование данных перед загрузкой подразумевает, что вы заранее знаете, как собираетесь их использовать. Другими словами, если вы можете быть уверены, что ваши приложения и бизнес-процессы всегда будут использовать одни и те же форматы, то обычно можно безопасно преобразовать данные в нужные форматы перед их загрузкой в ​​хранилище данных.

> [!NOTE]
> В ELT мы исходим из противоположного предположения. Загружая данные в хранилище без предварительного преобразования, вы предоставляете другим приложениям возможность преобразовывать их по своему усмотрению.


<p align="center">
<img width="1600" height="914" alt="image" src="https://github.com/user-attachments/assets/aac584df-3858-4532-9333-acb88113674e" />
</p>
...
Чтобы запустить полный ETL-процесс, нужно выполнить следующие шаги: сначала настроить окружение, а затем запустить сам скрипт пайплайна.
