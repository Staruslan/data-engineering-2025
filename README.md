# **Data Engineering 2025**
 :white_check_mark: (ДЗ1) Ссылка на датасет https://drive.google.com/drive/folders/17CqpL_vUcgqztIK5kGpLKhGqC8Ex8KJ-?usp=drive_link (Запись передвижения даюораторной крымы)
 ____
