...
>
> Целевая аудитория моего проекта —  специалисты, занимающиеся изучением поведения лабораторныхкрыс и мониторингом их передвижения в рамках научных исследованийисследователи в области медицины, которые смогут использовать эти данные для реконструкции траекторий движения.
